/* CMPINF 0401 Summer 2024 Java Example 1
...
{                 // even if we are not programming in an object-oriented
      ...
      public static void main (String [] weasel)
	  {
		   int two = 12345;
		   System.out.println(two);
		   System.out.println("The ones digit of " + two + " is " + two % 10);
		   int tens = ((two % 100)/10);
		   System.out.println("The Tens digit of " + two + " is " + tens);
		   double big = 123.45678;
		   double round = (int)((big * 1000) + 0.5);
		   double small = round/1000;
		   System.out.println("The number " + big + " rounded to 3 decimal places is " + small);
	  	   int wacky = 8;
		   // System.out.print("Java is awesome by a factor of " + wacky + "\n");
		   // System.out.println("\tYou entered " + weasel[0] + " and " + weasel[1]);
